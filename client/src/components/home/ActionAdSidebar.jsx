...
export const ReportIssueAd = () => (
  <div className="bg-gradient-to-br from-primary-600 to-primary-700 rounded-xl p-5 text-white shadow-lg overflow-hidden relative animate-shimmer group spot-problem-card">
    ...
    <div className="relative z-10">
      <h3
        className="text-lg font-bold mb-2 animate-slide-up-fade spot-problem-title"
        style={{ animationDelay: "0.1s" }}
      >
        Spot a problem?
      </h3>
      <p
        className="text-primary-100 text-sm mb-4 animate-slide-up-fade spot-problem-description"
        style={{ animationDelay: "0.2s" }}
      >
        Be the change in your community. Report issues like potholes, garbage,
  ...
  <div className="bg-dark-800 border border-dark-700 rounded-xl p-5 shadow-sm hover:border-dark-500 transition-colors group">
    ...
    <div className="space-y-3">
      {[
        ...
        <div
          key={i}
          className="flex justify-between items-center text-sm group-hover:translate-x-1 transition-transform"
    ...
    <Link
      to="/map"
      className="mt-4 text-xs text-dark-400 hover:text-white transition-colors flex items-center justify-center gap-1 group-hover:text-primary-400"
    >
      View Live Heatmap{" "}
      <ArrowRight
        size={12}
  ...
  <div className="bg-emerald-900/10 border border-emerald-500/20 rounded-xl p-5 hover:bg-emerald-900/20 transition-colors duration-500">
    <div className="flex flex-col items-center text-center">
      ...
      <p className="text-dark-300 text-xs mb-3">
        <span className="text-emerald-400 font-bold">1,240+</span> issues
        resolved this month by citizens like you.
      </p>
    </div>
  </div>
);
  ...
  return (
    <div className="bg-dark-800 border border-dark-700 rounded-xl overflow-hidden group cursor-pointer hover:border-dark-600 transition-colors shadow-lg hover:shadow-emerald-900/10">
      <div className="relative h-40 bg-dark-900 overflow-hidden">
        ...
        <div
          className={`absolute inset-0 transition-opacity duration-1000 ease-in-out flex flex-col items-center justify-center bg-gradient-to-br from-red-900/40 to-dark-900 ${
        ...
        <div
          className={`absolute inset-0 transition-opacity duration-1000 ease-in-out flex flex-col items-center justify-center bg-gradient-to-br from-emerald-900/40 to-dark-900 ${
